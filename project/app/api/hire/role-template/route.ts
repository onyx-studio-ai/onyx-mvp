...
const COLUMNS: { h: string; w: number; req?: boolean }[] = [
  ...
  { h: '特殊聲音', w: 18 },
  { h: '口音/語言', w: 12 },
  { h: '試音台詞', w: 40, req: true },
  { h: '角色圖連結', w: 24 },
  { h: '備註/情境', w: 24 },
];

const SAMPLES: string[][] = [
  ['阿薇', '主角', '女', '青年', '清亮、溫暖、偏年輕', '開朗直率、講話快', '著急', '約 1,200 字 / 80 句', '戰鬥喘息、笑聲', '不指定', '別愣著!他們快追上來了,跟我走!', '', '被追殺、邊跑邊回頭喊同伴 —— 急促但不能尖'],
  ['守城老兵', '', '男', '熟齡', '低沉、沙啞、威嚴', '話少、沉穩內斂', '沉穩', '約 300 字 / 20 句', '', '不指定', '城門一旦失守,我們就退無可退了。', '', '城牆上向年輕士兵交代'],
];
