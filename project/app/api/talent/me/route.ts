...
const TEXT_FIELDS = ['name', 'english_name', 'phone', 'bio', 'gender', 'location', 'availability_note', 'studio_partner', 'equipment', 'clients', 'awards', 'notable_works', 'special_skills', 'turnaround', 'portfolio_url'] as const;

const COLS =
  'id, name, english_name, bio, languages, accent, gender, tags, voice_traits, specialties, voice_ages, demos, demo_urls, headshot_url, ' +
  'location, phone, availability_note, equipment, studio_partner, clients, awards, notable_works, special_skills, turnaround, portfolio_url, years_experience, native_languages, type, email, is_active, ' +
