    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="min-w-0">
          ...
          {t.email && <p className="text-xs text-gray-500 truncate">{tr('cardContact')}<a href={`mailto:${t.email}`} className="text-blue-600 hover:underline">{t.email}</a>
            <a href={`/admin/messages?talent=${t.id}`} className="ml-2 text-emerald-600 hover:underline whitespace-nowrap">💬 傳訊息</a></p>}
