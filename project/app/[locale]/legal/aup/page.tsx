...
export const metadata: Metadata = {
  title: 'Acceptable Use Policy | Onyx Studios',
  description: 'Acceptable Use Policy defining permissible use of Onyx AI Voice Synthesis and Global Music Production Services.',
};
    ...
    <main className="min-h-screen bg-[#050505] text-white">
      <div className="max-w-3xl mx-auto pt-32 pb-16 px-6">
        <div className="mb-10 pb-6 border-b border-white/10">
          ...
          <PageTitle page="aup" locale={locale}>{t('title')}</PageTitle>
        ...
        <article className="space-y-8 text-[13px] leading-relaxed text-gray-400">
          {Array.from({ length: 24 }, (_, i) => i + 1).map(n => (
            <section key={n}>
              <SH id={`aup.${n}`} locale={locale}>{t(`s${n}Title`)}</SH>
              <div
