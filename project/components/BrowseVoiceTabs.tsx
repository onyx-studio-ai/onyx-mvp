...
export default function BrowseVoiceTabs() {
  ...
  return (
    <div className="inline-flex gap-1 p-1 rounded-full bg-white/[0.04] border border-white/10 mb-6">
      <Link href="/voices" className={`${base} ${aiActive ? 'bg-white text-black' : 'text-gray-300 hover:text-white'}`}>
        {tx('AI 聲音', 'AI 声音', 'AI Voices')}
      </Link>
      <Link href="/talents" className={`${base} ${!aiActive ? 'bg-white text-black' : 'text-gray-300 hover:text-white'}`}>
