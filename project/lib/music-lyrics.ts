// Auto-generated from ~/Desktop/onyx_music_samples/歌曲/*.rtf
// Full Suno-output lyrics for vocal POP catalog. Do not hand-edit;
// re-run the Python extractor in /tmp/extract_lyrics.py if RTF source changes.

export const MUSIC_LYRICS: Record<string, string> = {
  'pop-ballad-en': `[Verse 1]
Your mug still by the sink
Half of the bed still cold
I fold your shirt too slow
Like I can hold you close

I leave the hall light on
For a body that won't come home
And every little sound
Feels louder all alone

[Pre-Chorus]
I try to breathe it in
Try to let it go
But the quiet in this room
...
I walk right past those ghosts
Like you might be standing there

The kettle starts and stops
I stare at the ceiling line
...
[Bridge]
Talk to me in slow motion
Tell me what you need
I can feel the whole room
...
把你自己
慢慢帶回手中`,
  'hiphop-trap-en': `[Verse 1]
Came from nothing, got it all
Cold rooms, small meals, big talk
No one handed me a lane
I learned pressure like a sport
...
Watch me level up
Came from nothing, got it all
Came from nothing, got it all (yeah)
One brick, one line
I built it up

[Verse 2]
Now they want the play-by-play
How I made the floor turn gold
...
I was quiet, I was hungry
Now the room knows my name
Same hands that were empty
...
Just faith and a deadline
I turned low into greater
Now the whole block see me shine
...
現在站上 換我來笑
未來的路 我自己挑`,
  'indie-bedroom-en': `[Verse 1]
Afternoon light across the floor
Your shoes by the half-closed door
You lean in like you know the code
And my whole chest goes soft and slow

[Pre-Chorus]
Time gets thin
When you're this near
I lose the hour
I lose the fear
...
[Verse 2]
Tea gone cold on the window ledge
Your sleeve brushed mine at the table edge
We talk in half-sent pieces now
Still, you pull me all the way down
...
Sube, sube, you got me wild
Baila, baila, pega fuerte
...
[Verse 2]
Tu risa rompe el mar
on the shore we spin
Los amigos lejos
and we fall back in
